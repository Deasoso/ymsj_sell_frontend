      ...
      <!-- <div class="hero-body"> -->
        <div class="container toleft">
          <div class="titlepos whiteborder">
            <div class="titletext">{{$t('科学与魔法并存，这里有引人入胜的世界观...')}}</div>
          </div>
          <div class="subtitlepos whiteborder">
            <div class="subtitletext">{{$t('玩家是一名刚刚继承家族的隐秘家族传承者，拥有调动家族人员、资产的权利，同时也肩负了家族发展的责任，究竟是坐吃山空还是招兵买马、扩张势力，都由玩家自己来决定。')}}</div>
          </div>
          <div class="textbackpos">
            <div class="intext">{{$t('《隐秘世界OL》脱胎于同名桌游，是一款集换式卡牌对战游戏（TCG），游戏展现了众多隐藏于现实世界之下的超自然力量：法师和异族行走在阴影中，众多秘密结社以阴谋和魔法争夺人世的权柄...玩家将成为其中一方的领袖，带领族人争夺地盘，获得荣光！')}}</div>
          </div>
          <div class="buttonpos" @click="$router.push('/Shop')">
            <a><img class="goldbutton" src="http://ymsjimg.deaso40.com/title_slices/button1.png"></a>
            <a><div class="buttontext">{{$t('立即前往')}}</div></a>
